...
## 1. Foundational Learning Philosophy

### Core Principles

**Learning is inherently social and collaborative.** Like a student attending video game camp not for the screen time but for the community built around shared engagement, all authentic learning happens through connection with others.

**Process matters more than product.** We celebrate being "in process"—the messy, uncertain, revelatory work of thinking through problems, questioning assumptions, and building understanding over time.

**Multiple paths lead to wisdom.** We honor unconventional educational journeys and reject the myth that there's one "right way" to learn. Each learner's path is as "precarious as it is precious."

**Creation over consumption.** Students should be makers of meaning, not just consumers of content. Like video essayists who "observe, react with others, build cohesive thought, gather evidence, and create trans-media representations," learners engage actively with their world.

**Intrinsic motivation drives lasting learning.** We protect and nurture curiosity, wonder, and the joy of discovery rather than relying on external rewards or punishments.
...
## 2. Democratic Governance & Stakeholder Input
...
**Student Voice as Primary:** Students aren't just "users" of educational AI—they're co-designers of their learning experience. We create multiple pathways for students to:
...
**Teacher Professional Wisdom:** Educators bring irreplaceable insights about learning, development, and classroom dynamics. We ensure:
...
**Community and Family Input:** Learning doesn't happen in isolation. We engage:
...
## 3. Human-Centered Learning Design

### AI as Learning Facilitator, Never Replacement
...
**How AI enhances rather than replaces:**
...
**Teachers maintain control over:**
...
## 4. Assessment Philosophy & Practice

### Beyond Test Outcomes: Evidence of Learning and Growth
...
### Assessment as Learning, Not Just Measurement

**Formative feedback that guides learning:**
...
**Authentic assessment connected to real purposes:**
...
### AI-Supported Assessment Principles
...
## 5. AI Guardrails: Engaging vs. Subverting Thinking

### Core Principle: AI Must Amplify Human Thinking, Never Replace It

**The fundamental test:** Does this AI interaction make the student a stronger thinker, or does it make thinking unnecessary?
...
### Blocked AI Behaviors: What AI Will Not Do
...
### AI as Challenge Creator, Not Answer Provider
...
## 7. Privacy, Safety & Well-being

### Student Data as Sacred Trust

**We protect not just privacy but learning agency.** Students should understand what data is collected, how it's used, and maintain control over their learning narrative.
...
- **Thinking Engagement Rubrics** - Tools for evaluating whether AI interactions strengthen student thinking
...
*Find all implementation tools in the [/implementation-tools/](docs/implementation-tools/) directory.*
